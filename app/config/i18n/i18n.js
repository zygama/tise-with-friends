...
import en_translations from './english.json';
import fr_translations from './french.json';

// Enable fallbacks if you want `en-US` and `en-GB` to fallback to `en`
I18n.fallbacks = true;

// Add different defaultLocale here (default is 'en'). It will be used as a fallback when device
// locale isn't found in translations
